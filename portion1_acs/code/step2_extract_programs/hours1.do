*hours1 based on rank_revised_extravars
*read simple data sets created by myyyy.do 
*create person level extract with obs for nonworkers

cap log close
log using hours1.log, replace
...
keep age female educ twage hrswkly weeksly imm yoep region_birth pob wnh bnh anh hispanic mobility pweight ncz cz1-cz10 af1-af10 field_degree ind occ cow wagsal selfearn
gen year = `y'
...
keep age female educ twage hrswkly weeksly imm yoep region_birth pob wnh bnh anh hispanic mobility pweight ncz cz1-cz9 af1-af9 ind occ field_degree cow wagsal selfearn
gen year = `y'
...
compress
save ${scratch}/hours_alldata.dta, replace
