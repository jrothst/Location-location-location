*program phi_cz_byed to estimate CZ diffs for college and hs 
...
cap log close
log using phi_cz_byed.log, replace
...
predict cz_effects_hs_m2, d
predict skill_hs_m2, xb

replace cz_effects_hs_m2=. if educ~=12
replace skill_hs_m2=. if educ~=12
...
i.educ#female i.educ#imm i.educ#useducated imm_LatAm imm_Asia imm_EurNAOceania ysa imm_LatAm_ysa imm_Asia_ysa imm_EurNAOceania_ysa i.fod i.fod#female i.year [aw=pweight], absorb(cz)
predict cz_effects_coll_m2, d
predict skill_coll_m2, xb

replace cz_effects_coll_m2=. if educ~=16
replace skill_coll_m2=. if educ~=16
...
predict cz_effects_hs_m3, d
predict skill_hs_m3, xb

replace cz_effects_hs_m3=. if educ~=12
replace skill_hs_m3=. if educ~=12


areg logwagecoll age female f_age exp exp2 exp3 exp4 f_exp f_exp2 f_exp3 f_exp4 wnh bnh anh hispanic f_wnh f_bnh f_anh f_hispanic imm useducated i.educ ///
i.educ#female i.educ#imm i.educ#useducated imm_LatAm imm_Asia imm_EurNAOceania ysa imm_LatAm_ysa imm_Asia_ysa imm_EurNAOceania_ysa i.fod i.fod#female i.year i.ind [aw=pweight], absorb(cz)
predict cz_effects_coll_m3, d
predict skill_coll_m3, xb

replace cz_effects_coll_m3=. if educ~=16
replace skill_coll_m3=. if educ~=16


sum logwage logwagehs logwagecoll cz_effects_hs_m2 cz_effects_hs_m3 cz_effects_coll_m2 cz_effects_coll_m3 [w=pweight]
...
collapse (mean) logwagehs logwagecoll cz_effects_hs_m2 cz_effects_hs_m3 cz_effects_coll_m2 cz_effects_coll_m3 skill_hs_m2 skill_hs_m3 skill_coll_m2 skill_coll_m3  (sum) wcount_hs=c_hs wcount_coll=c_coll [pw=pweight], by(cz)

save ${scratch}/czeffects_byed, replace
