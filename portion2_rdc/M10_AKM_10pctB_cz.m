...
%Paths - need to set appropriately
%path to the matlabBGL files 
path(path,'[MABLAB_BGL]'); 
datadir='[DATA]';
yidata='[YIDATA]';

system('rm M10_AKM_10pctB_230306.log')
diary('M10_AKM_10pctB_230306.log')
clear
...
% cz ('uint16') NOTE: this is named firmid
firmid=data(:,7);
